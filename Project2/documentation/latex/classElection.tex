...
\item 
\hyperlink{classBallot}{Ballot} $\ast$ {\bfseries get\+Loser\+Ballot\+List} (int \&n, int \&idx)\hypertarget{classElection_a849156c7480c1f015bffd13098276b48}{}\label{classElection_a849156c7480c1f015bffd13098276b48}

\item 
void \hyperlink{classElection_ab40f687c6cca23d2b62e8e5f42e91e9d}{shuffle\+Ballots} (int piles=5)
...
\end{DoxyReturn}
\index{Election@{Election}!generate\+Report\+File@{generate\+Report\+File}}
\index{generate\+Report\+File@{generate\+Report\+File}!Election@{Election}}
\subsubsection[{\texorpdfstring{generate\+Report\+File(const char $\ast$fname)}{generateReportFile(const char *fname)}}]{\setlength{\rightskip}{0pt plus 5cm}int Election\+::generate\+Report\+File (
\begin{DoxyParamCaption}
\item[{const char $\ast$}]{fname}
\end{DoxyParamCaption}
)}\hypertarget{classElection_a110e20ed39a0aeabe0e063a554441ce3}{}\label{classElection_a110e20ed39a0aeabe0e063a554441ce3}
...
\hline
\end{DoxyParams}
\index{Election@{Election}!shuffle\+Ballots@{shuffle\+Ballots}}
\index{shuffle\+Ballots@{shuffle\+Ballots}!Election@{Election}}
\subsubsection[{\texorpdfstring{shuffle\+Ballots(int piles=5)}{shuffleBallots(int piles=5)}}]{\setlength{\rightskip}{0pt plus 5cm}void Election\+::shuffle\+Ballots (
\begin{DoxyParamCaption}
\item[{int}]{piles = {\ttfamily 5}}
\end{DoxyParamCaption}
)}\hypertarget{classElection_ab40f687c6cca23d2b62e8e5f42e91e9d}{}\label{classElection_ab40f687c6cca23d2b62e8e5f42e91e9d}
idea\+: create n piles (specified by parameter piles) and distribute each ballot to each pile. Then combine all piles.\index{Election@{Election}!to\+String@{to\+String}}
